...
function HeroSection() {
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 bg-gradient-to-b from-gray-50 via-white to-white overflow-hidden relative">
      <div className="absolute top-20 right-0 w-96 h-96 bg-ruby-100 rounded-full blur-3xl opacity-40" />
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-ruby-50 rounded-full blur-3xl opacity-60" />
      
      <div className="container mx-auto px-4 relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-ruby-50 text-ruby-700 rounded-full text-sm font-medium mb-8 border border-ruby-100">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a href="#demo" className="px-8 py-4 bg-white border-2 border-gray-200 text-gray-700 rounded-xl font-semibold hover:border-ruby-200 hover:text-ruby-600 transition-all flex items-center justify-center gap-2 shadow-sm">
                Ver Demonstração
              </a>
            </div>
            ...
            <div className="flex gap-10 mt-14 justify-center lg:justify-start">
              <div className="text-center lg:text-left">
                ...
                <div className="text-gray-500 text-sm mt-1">Salões Ativos</div>
              </div>
              <div className="text-center lg:text-left">
                <div className="text-3xl font-bold text-gray-900">1M+</div>
                <div className="text-gray-500 text-sm mt-1">Agendamentos/mês</div>
              </div>
              <div className="text-center lg:text-left">
                ...
                <div className="text-gray-500 text-sm mt-1">Avaliação</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
              ...
              <div className="p-6 bg-white">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="bg-gradient-to-br from-ruby-50 to-white p-4 rounded-xl border border-ruby-100">
                    <div className="flex items-center gap-2 mb-2">
                      <Calendar className="w-5 h-5 text-ruby-600" />
                      <span className="text-sm text-gray-600 font-medium">Hoje</span>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-white p-4 rounded-xl border border-emerald-100">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm text-gray-600 font-medium">Receita</span>
                    </div>
                    <div className="text-2xl font-bold text-gray-900">R$ 4.850</div>
                    <div className="text-xs text-emerald-600 font-medium">+12% vs ontem</div>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-xl border border-gray-100">
                  <div className="text-sm font-semibold text-gray-900 mb-3">Próximos Agendamentos</div>
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 py-3 border-b border-gray-50 last:border-0">
                      <div className="text-sm font-semibold text-ruby-600 w-14">{item.time}</div>
            ...
            <div className="absolute -top-10 -right-10 w-80 h-80 bg-gradient-to-br from-ruby-200 to-ruby-100 rounded-full blur-3xl opacity-50" />
            <div className="absolute -bottom-10 -left-10 w-60 h-60 bg-gradient-to-br from-ruby-100 to-ruby-50 rounded-full blur-3xl opacity-60" />
          </div>
        </div>
      </div>
    </section>
...
const colorClasses: Record<string, { bg: string; icon: string; border: string }> = {
  ruby: { bg: 'bg-ruby-50', icon: 'text-ruby-600', border: 'border-ruby-100' },
    ...
    <section id="features" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-ruby-600 font-semibold text-sm uppercase tracking-wider">Recursos</span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="group p-6 bg-white rounded-2xl border border-gray-100 hover:border-ruby-200 hover:shadow-xl hover:shadow-ruby-500/5 transition-all duration-300">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-gray-50 to-white rounded-2xl border border-gray-100">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900">E muito mais...</h3>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {['Controle de Estoque', 'Multi-Unidades', 'App para Profissionais', 'Relatórios Detalhados', 'Notas Fiscais', 'Gestão de Equipe', 'Assinatura Digital', 'API para Integrações'].map((item, i) => (
              <div key={i} className="flex items-center gap-3 p-3 rounded-lg hover:bg-white transition-colors">
                <div className="w-5 h-5 rounded-full bg-ruby-100 flex items-center justify-center">
                  <Check className="w-3 h-3 text-ruby-600" />
                </div>
...
function PricingSection() {
  return (
    <section id="pricing" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-ruby-600 font-semibold text-sm uppercase tracking-wider">Planos</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3 mb-4">Planos para todos os tamanhos</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            <div key={index} className={`relative p-8 bg-white rounded-2xl ${plan.popular ? 'ring-2 ring-ruby-500 shadow-xl shadow-ruby-500/10 scale-105' : 'border border-gray-200 shadow-sm'}`}>
              {plan.popular && (
              ...
              <ul className="space-y-4 mb-8">
                {plan.features.map((feature, i) => (
                  <li key={i} className="flex items-center gap-3">
                    <div className="w-5 h-5 rounded-full bg-ruby-100 flex items-center justify-center flex-shrink-0">
                      <Check className="w-3 h-3 text-ruby-600" />
                    </div>
...
function TestimonialsSection() {
  return (
    <section id="testimonials" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-ruby-600 font-semibold text-sm uppercase tracking-wider">Depoimentos</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3 mb-4">Amado por milhares de profissionais</h2>
          <p className="text-lg text-gray-600">Veja o que nossos clientes dizem sobre o Glamo</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="p-8 bg-white rounded-2xl border border-gray-100 hover:shadow-xl hover:shadow-gray-900/5 transition-all duration-300">
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <span className="text-ruby-600 font-semibold text-sm uppercase tracking-wider">FAQ</span>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-3 mb-4">Perguntas Frequentes</h2>
        </div>

        <div className="max-w-3xl mx-auto space-y-4">
          {faqs.map((faq, index) => (
            <div key={index} className="bg-white rounded-xl border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
