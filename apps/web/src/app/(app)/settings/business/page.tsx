...
const fetchBusinessData = async (tenantName: string): Promise<BusinessData> => {
...
export default function BusinessSettingsPage() {
  ...
  const { data: initialData, isLoading: pageLoading } = usePageData(
    () => fetchBusinessData(tenant?.name || ''),
    { cacheKey: `business-settings-${tenant?.slug}`, initialData: {
      name: tenant?.name || '',
      cnpj: '',
      phone: '',
      whatsapp: '',
