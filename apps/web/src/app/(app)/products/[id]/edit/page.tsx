/**
 * GLAMO - Edit Product Page
 * Enterprise-grade product editing form
...
function PreviewCard({ data, categoryName, currentStock }: PreviewCardProps) {
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2 text-sm">
            ...
            <div className="p-2 rounded bg-muted/50 text-center">
              ...
              <p className="font-medium">{data.minStock || 0}</p>
            </div>
            <div className="p-2 rounded bg-muted/50 text-center">
              <p className="text-xs text-muted-foreground">Máximo</p>
              <p className="font-medium">{data.maxStock || '—'}</p>
            </div>
          </div>
        </div>
...
export default function EditProductPage() {
  ...
  }, [hasUnsavedChanges, productId, router]);
            ...
            <div className="lg:col-span-2 space-y-6">
                    ...
                    <CardContent className="space-y-4">
                      <div className="rounded-lg border p-4 bg-muted/30">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Para alterar o estoque, use a movimentação na página de detalhes
                        </p>
                      </div>
              ...
              <Card className="border-destructive">
                <CardHeader>
                  ...
                  <CardDescription>
                    Ações irreversíveis para este produto
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium">Excluir produto</p>
                      <p className="text-sm text-muted-foreground">
                        O produto será movido para a lixeira e poderá ser restaurado
                      </p>
                    </div>
                    <Button
                      type="button"
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-muted/30">
                ...
                <CardContent className="space-y-2 text-xs text-muted-foreground">
                  <p>• Altere o estoque na página de detalhes</p>
                  <p>• Use a calculadora para ajustar margem</p>
                  <p>• Configure alertas de estoque mínimo</p>
                  <p>• Tags ajudam na busca rápida</p>
                </CardContent>
              </Card>
            </div>
          </div>
