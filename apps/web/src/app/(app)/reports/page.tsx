...
const mockTopProfessionals: TopProfessional[] = [
...
// Função para buscar dados de relatórios - substituir por API real
...
export default function ReportsPage() {
  ...
  const { data: reportsData, isLoading } = usePageData(
    fetchReportsData,
    { cacheKey: 'reports-overview', initialData: mockReportsData }
  );

  const { stats, topServices, topProfessionals, revenueByDay } = reportsData || mockReportsData;
