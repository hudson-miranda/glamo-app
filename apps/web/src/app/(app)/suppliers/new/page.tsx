/**
 * GLAMO - New Supplier Page
 * Enterprise-grade supplier creation form
...
export default function NewSupplierPage() {
  ...
  const { create, isCreating } = useSupplierMutations();
  ...
  const onSubmit = async (data: SupplierFormData) => {
    try {
      ...
      const supplier = await create(supplierData);
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-muted/30">
                ...
                <CardContent className="space-y-2 text-xs text-muted-foreground">
                  <p>• Preencha o CNPJ para identificação fiscal</p>
                  <p>• Adicione dados bancários para pagamentos</p>
                  <p>• Use tags para categorizar fornecedores</p>
                  <p>• Cadastre o contato principal para agilizar comunicação</p>
                </CardContent>
              </Card>
            </div>
          </div>
